...
#count how many times same charcter is in list
...
func _physics_process(delta):
	...
	#revert mage attack to rest of charcters attacks
	if magechosen == false:
		$attacks/attack1.show()
		$attacks/attack1mage.hide()

#set attack sprites when charcters change
	match speed:
		1: 
			if chara6 > 0:
				$attacks/attack1.set_frame(6-1)
				$attacks/attack2.set_frame(6-1)
				$attacks/attack3.set_frame(6-1)
		...
		2:
			if chara4 > 0:
				...
				$attacks/attack2.set_frame(4-1)
				$attacks/attack3.set_frame(4-1)
		...
		3:
			if chara10 > 0:
				...
				$attacks/attack2.set_frame(10-1)
				$attacks/attack3.set_frame(10-1)
		...
		4:
			if chara1 > 0:
				...
				$attacks/attack2.set_frame(1-1)
				$attacks/attack3.set_frame(1-1)
		...
		5:
			if chara7 > 0:
				...
				$attacks/attack2.set_frame(7-1)
				$attacks/attack3.set_frame(7-1)
		...
		6:
			if chara8 > 0:
				...
				$attacks/attack2.set_frame(8-1)
				$attacks/attack3.set_frame(8-1)
		...
		7:
			if chara3 > 0:
				...
				$attacks/attack2.set_frame(3-1)
				$attacks/attack3.set_frame(3-1)
		...
		8:
			if chara5 > 0:
				...
				$attacks/attack2.set_frame(5-1)
				$attacks/attack3.set_frame(5-1)
				$Selected/current.set_frame(5-1)
				#mage pick random elemental attack
				if magechosen == false:
		...
		9:
			if chara9 > 0:
				...
				$attacks/attack2.set_frame(9-1)
				$attacks/attack3.set_frame(9-1)
		...
		10:
			if chara2 > 0:
				...
				$attacks/attack2.set_frame(2-1)
				$attacks/attack3.set_frame(2-1)
		...
		11:
			if chara11 > 0:
				...
				$attacks/attack2.set_frame(11-1)
				$attacks/attack3.set_frame(11-1)
...
#attacks set amount depending on how many of same characters
